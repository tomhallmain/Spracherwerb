...
from Spracherwerb.run_context import RunContext
...
class Playback:
    ...
    def delay(self):
        if self.has_played_first_track and not self.last_track_failed:
            ...
            while not self._run_context.skip_delay and delay_timer < self.remaining_delay_seconds:
                time.sleep(0.5)
                delay_timer += 0.5
            if self._run_context.skip_delay:
    ...
    def pause(self):
        ...
        self._run_context.is_paused = True
    ...
    def next(self):
        ...
        self._run_context.skip_track = True
        self._run_context.skip_delay = True
    ...
    def next_grouping(self):
        ...
        self._run_context.skip_track = True
        self._run_context.skip_delay = True
        self._run_context.skip_grouping = True
